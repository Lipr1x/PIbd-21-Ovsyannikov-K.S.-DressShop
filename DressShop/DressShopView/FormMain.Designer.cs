namespace AbstractShopView
{
	partial class FormMain
	{
		...
		private void InitializeComponent()
		{
            ...
            this.компонентыПоПлатьямToolStripMenuItem = new System.Windows.Forms.ToolStripMenuItem();
            ...
            this.запускРаботToolStripMenuItem.Size = new System.Drawing.Size(180, 22);
            ...
            this.компонентыПоПлатьямToolStripMenuItem,
            ...
            // 
            // компонентыПоПлатьямToolStripMenuItem
            // 
            this.компонентыПоПлатьямToolStripMenuItem.Name = "компонентыПоПлатьямToolStripMenuItem";
            this.компонентыПоПлатьямToolStripMenuItem.Size = new System.Drawing.Size(211, 22);
            this.компонентыПоПлатьямToolStripMenuItem.Text = "Компоненты по платьям";
            this.компонентыПоПлатьямToolStripMenuItem.Click += new System.EventHandler(this.компонентыПоПлатьямToolStripMenuItem_Click);
            // 
        ...
        private System.Windows.Forms.ToolStripMenuItem компонентыПоПлатьямToolStripMenuItem;
